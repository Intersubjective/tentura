...
class Friends extends Table with TableInfo<Friends, FriendsData> {
  ...
  @override
  List<GeneratedColumn> get $columns => [subjectId, objectId, title, hasAvatar];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  FriendsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return FriendsData(
      ...
      hasAvatar: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}has_avatar'],
      )!,
    );
  }
...
class FriendsData extends DataClass implements Insertable<FriendsData> {
  ...
  @override
  int get hashCode => Object.hash(subjectId, objectId, title, hasAvatar);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Accounts extends Table with TableInfo<Accounts, AccountsData> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, title, hasAvatar];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class AccountsData extends DataClass implements Insertable<AccountsData> {
  ...
  AccountsData copyWith({String? id, String? title, bool? hasAvatar}) =>
      AccountsData(
        id: id ?? this.id,
        title: title ?? this.title,
        hasAvatar: hasAvatar ?? this.hasAvatar,
  ...
  @override
  int get hashCode => Object.hash(id, title, hasAvatar);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
