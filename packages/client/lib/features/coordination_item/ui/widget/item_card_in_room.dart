...
class ItemCardInRoom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconData = coordinationItemEventIcon(
      item.kind,
      eventKind,
      isPlanStep: item.isPlanStep,
    );

    final color = coordinationItemEventColor(tt, item.kind, eventKind);
    ...
    if (onTap == null) return plaque;

    return GestureDetector(onTap: onTap, child: plaque);
  }
}
