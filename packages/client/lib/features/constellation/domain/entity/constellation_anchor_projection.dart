...
/// Beacon statuses eligible for upsert / dormant anchor retention (C2).
const kConstellationUpsertEligibleBeaconStatuses = {0, 7, 8, 5, 4, 6};

/// Default field membership when `showClosed` is false (C2).
const kConstellationDefaultFieldBeaconStatuses = {0, 7, 8};

/// Field membership when `showClosed` is true (C2).
...
/// Authorized anchor layer returned with a field snapshot (C4).
@immutable
