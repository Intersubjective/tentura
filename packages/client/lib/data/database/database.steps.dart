...
final class Schema2 extends i0.VersionedSchema {
  ...
  final i1.Index messagesObject = i1.Index(
    'messages_object',
    'CREATE INDEX messages_object ON messages (object_id)',
  );
  final i1.Index messagesSubject = i1.Index(
    'messages_subject',
    'CREATE INDEX messages_subject ON messages (subject_id)',
  );
  final i1.Index messagesUpdatedAt = i1.Index(
    'messages_updatedAt',
...
class Shape4 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get width =>
      columnsByName['width']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get fcmTokenUpdatedAt =>
      columnsByName['fcm_token_updated_at']! as i1.GeneratedColumn<String>;
}
...
class Shape6 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get valueInt =>
      columnsByName['value_int']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get valueBool =>
      columnsByName['value_bool']! as i1.GeneratedColumn<int>;
}
