...
enum CapabilityTag {
  ...
  // RPG (party roles — tongue-in-cheek)
  tank(slug: 'tank', group: CapabilityGroup.rpg),
  healer(slug: 'healer', group: CapabilityGroup.rpg),
  dps(slug: 'dps', group: CapabilityGroup.rpg),
  support(slug: 'support', group: CapabilityGroup.rpg),
  scout(slug: 'scout', group: CapabilityGroup.rpg),
  crafter(slug: 'crafter', group: CapabilityGroup.rpg),
  bard(slug: 'bard', group: CapabilityGroup.rpg),
  summoner(slug: 'summoner', group: CapabilityGroup.rpg),
  raidLeader(slug: 'raid_leader', group: CapabilityGroup.rpg),
  gm(slug: 'gm', group: CapabilityGroup.rpg),
  ...
  IconData get icon => switch (this) {
    ...
    CapabilityTag.tank => Icons.propane_tank_rounded,
    CapabilityTag.healer => Icons.volunteer_activism_rounded,
    CapabilityTag.dps => Icons.local_fire_department_rounded,
    CapabilityTag.support => Icons.support_agent_rounded,
    CapabilityTag.scout => Icons.visibility_rounded,
    CapabilityTag.crafter => Icons.auto_awesome_rounded,
    CapabilityTag.bard => Icons.mic_rounded,
    CapabilityTag.summoner => Icons.smart_toy_rounded,
    CapabilityTag.raidLeader => Icons.campaign_rounded,
    CapabilityTag.gm => Icons.casino_rounded,
