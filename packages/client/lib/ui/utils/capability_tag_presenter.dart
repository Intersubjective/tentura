...
extension CapabilityTagLabel on CapabilityTag {
  String labelOf(L10n l10n) => switch (this) {
    ...
    CapabilityTag.tank => l10n.capabilityTagTank,
    CapabilityTag.healer => l10n.capabilityTagHealer,
    CapabilityTag.dps => l10n.capabilityTagDps,
    CapabilityTag.support => l10n.capabilityTagSupport,
    CapabilityTag.scout => l10n.capabilityTagScout,
    CapabilityTag.crafter => l10n.capabilityTagCrafter,
    CapabilityTag.bard => l10n.capabilityTagBard,
    CapabilityTag.summoner => l10n.capabilityTagSummoner,
    CapabilityTag.raidLeader => l10n.capabilityTagRaidLeader,
    CapabilityTag.gm => l10n.capabilityTagGm,
