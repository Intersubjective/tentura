...
/// User `handle` (nullable, room-local nickname for @mentions) and
/// `beacon_room_message.mentions` (user ids extracted server-side).
/// Extends `notify_entity_change` `room_message` branch to fan-out to mentioned users.
final m0055 = Migration('0055', [
  '''
